...
<user.vim_normal_counted_action>:
    user.vim_run_any_motion("{vim_normal_counted_action}")
<user.vim_normal_counted_actions_keys>:
    user.vim_run_any_motion_key("{vim_normal_counted_actions_keys}")
<user.vim_counted_motion_command_with_ordinals>:
    user.vim_run_any_motion("{vim_counted_motion_command_with_ordinals}")

<user.vim_normal_counted_motion_command>:
    user.vim_run_any_motion("{vim_normal_counted_motion_command}")
